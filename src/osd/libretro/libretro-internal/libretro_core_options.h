...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   {
      CORE_NAME "_frames_to_delay_runahead",
      "Frames to Delay Runahead",
      NULL,
      "Delay kicking off runahead serialization cycles by a few frames to allow proper bootup and memory allocations to occur.\n This can potentially help games where Runahead single-instance mode can cause games to not boot correctly, or games where the hiscore plugin does not restore the scores.\n NOTE - This can cause the game to run at a faster speed during this warmup period because it executes frames faster until runahead kicks in.",
      NULL,
      "hacks",
      {
         { "default", "Default (Off)" },
